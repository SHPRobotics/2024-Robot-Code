...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    m_rearRight.setDesiredState(swerveModuleStates[3], "RR");
  }
  ...
  public void setModuleStates(SwerveModuleState[] desiredStates) {
    ...
    // apply speed and angle to each wheel
    m_frontLeft.setDesiredState(desiredStates[0], "FL");
    m_frontRight.setDesiredState(desiredStates[1], "FR");
    m_rearLeft.setDesiredState(desiredStates[2], "RL");
    m_rearRight.setDesiredState(desiredStates[3], "RR");
  }
