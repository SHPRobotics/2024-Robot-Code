...
public class MAXSwerveModule {
  ...
  // current chassis angular offset
  private double m_chassisAngularOffset = 0;
  // current Module State (speed, angle)
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    // tell PID controller that we use the intergrated encoder for the feedback device
    ...
    // save the current value of chassis angular offset
    m_chassisAngularOffset = chassisAngularOffset;
    // save the current wheel angle
    m_desiredState.angle = new Rotation2d(m_turningEncoder.getPosition());
    // reset robot position to zero
  ...
  public void setDesiredState(SwerveModuleState desiredState, String moduleName) {
    ...
    SmartDashboard.putString("Module State "+ moduleName, desiredState.toString());
